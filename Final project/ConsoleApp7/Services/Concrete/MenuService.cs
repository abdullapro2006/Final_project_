...

    {
        ...
        public static void MenuShowAllProducts()
        {
            try
            {
                ...
                {
                    Console.WriteLine($"Name:{product.Name}, ID:{product.ID}, Count:{product.Quantity}, Price:{product.Price}, Category:{product.Category}");
                }
            }
            ...
            try
            {
                ...
                foreach (var sale in sales)
                {
                   foreach(var item in sale.Items)
                    {
                        Console.WriteLine($"ID: {sale.ID} | Amount: {sale.Amount} | Name: {item.Product.Name} | Quantity: {item.Quantity} | Date: {sale.Date}");
                    }
                }
            }
            catch (Exception ex)
